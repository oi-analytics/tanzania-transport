...
plots = [
    ("AADT (thousand vehicles)", "curredaadt"),
]
...
for scenario in ["current_own_range"]:
    for legend_label, column in plots:
        for sectors in sector_groups:
            ...
            if min_weight == 0:
                mins = [0] + list(np.geomspace(70, max_weight, n_steps - 1))
            else:
            ...
            for (i, ((nmin, nmax), width)) in enumerate(width_by_range.items()):
                ...
                ax.add_geometries(
                    ...
                    facecolor='#000000',
                    zorder=2)
                if round(nmin) == round(max_weight):
            ...
            plt.legend(
                [
                    ...
                    regional_handle, rail_handle],
                [
                    "Airport", "Port", "Trunk Roads",
                    "Regional Roads", "Rail border crossing"
                ],
                handler_map={
